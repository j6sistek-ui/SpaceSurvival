...
OUT = ROOT/"ContentSource/FieldCandidates/V3"
...
def main():
    ...
    persisted=json.loads((ROOT/"Saved/Validation/FieldCandidatesV3Persisted.json").read_text(encoding="utf-8"))
    ...
    field,component=static("Field candidate only",BASE+"/Meshes/SM_ElectricalFieldCandidateV3",(0,0,0),34,False)
    ...
    record={"status":"RUNNING","errors":[],"images":[],"engine":u.SystemLibrary.get_engine_version(),
            ...
            "persisted_receipt_sha256":author.sha(ROOT/"Saved/Validation/FieldCandidatesV3Persisted.json"),
    ...
    def setup():
        ...
        mesh_name="SM_"+kind+"FieldCandidateV3"
        material_name="M_"+kind+"FieldCandidateV3"
    ...
    def finish():
        ...
        u.log("FIELD_CANDIDATE_V3_PREVIEW_FINISHED")
