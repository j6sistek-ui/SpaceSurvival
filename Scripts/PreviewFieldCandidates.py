...
OUT = ROOT/"ContentSource/FieldCandidates"
...
def main():
    ...
    persisted=json.loads((ROOT/"Saved/Validation/FieldCandidatesPersisted.json").read_text(encoding="utf-8"))
    ...
    field,component=static("Field candidate only",BASE+"/Meshes/SM_ElectricalFieldCandidate",(0,0,0),34,False)
    ...
    record={"status":"RUNNING","errors":[],"images":[],"engine":u.SystemLibrary.get_engine_version(),
            ...
            "persisted_receipt_sha256":author.sha(ROOT/"Saved/Validation/FieldCandidatesPersisted.json"),
    ...
    def setup():
        ...
        mesh_name="SM_"+kind+"FieldCandidate"
        material_name="M_"+kind+"FieldCandidate"
    ...
    def finish():
        ...
        u.log("FIELD_CANDIDATE_PREVIEW_FINISHED")
