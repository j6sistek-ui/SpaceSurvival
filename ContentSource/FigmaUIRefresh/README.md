...
September22 follow-up adds exact KIT scrollbar track/thumb/arrows (80:58–61), crew (45:10) and service (45:25) icons, bringing the family to33 textures. Wardrobe shows six32px rows with pinned Back, wheel/arrow/track/drag navigation and selected-row auto-scroll. Slider layers share their measured rail centreline and endpoints. Walking omits flight vitals/weapons and adds a60m heading-relative radar: visible crew, functional services and owned pad positions; out-of-range symbols stay on the rim. These are current world contacts, not decorative example dots.
