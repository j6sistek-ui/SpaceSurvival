...
**Phase 1: PARTIAL.** Star-adjusted visual pass ready for owner review, September 14, 2026; PR creation pending at this checkpoint. [Open work and your next review](KNOWN_ISSUES.md) owns active priorities, owner checks and closure status. This page owns the source/build/release and storage explanation.
...
| Current visual source | `codex/visual-enhancement`, commit `cf6296f286dba9a89583649e19f988ed09af2f16`, stacked on PR #11 at `b2304546` | Material-only star adjustment after `4dc45ac`; C++ remains unchanged from Editor Build 12 (44.21 seconds), 49 passing Unreal tests at 23:57:10 UTC and the 30-file C++ format audit. Those checks were not rerun for the star adjustment. The 725-file fresh Git export passed at `cf6296f`. No merge or itch upload. |
