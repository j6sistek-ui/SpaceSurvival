...
| --- | --- | --- |
| GitHub source | PRs #11 and #12 merged at `e0af942` and `c0479cf`; current main verified `c0479cfeba34e826143a3e40a45e79162f9f8697` | Documentation foundation and visual pass are in main. The release publisher guard and release records are in the separate review branch; source merge and itch publication were verified independently. |
