...
**Current source after Package 10:** combat-cue milestone `21a2572830f88be465d7a7c2ac0c229114ef5ede` is pushed. CI run 34751108625 passed source checks and 744 strict plus 744 ASan/UBSan assertions. The subsequent font change compiled and passed a bounded native 1920x1080 menu review at 100/110/120 percent scale; full gameplay label and scale/resolution acceptance remain open. See [font record](validation/2026-09-13-hud-font-menu.json). Separate enemy, field and grip candidates are under review and are not selected by gameplay.
