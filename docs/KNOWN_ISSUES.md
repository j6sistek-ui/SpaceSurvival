...
**Package4 is the current review candidate; reports remain OPEN.** Source `79553fc`, inner EXE SHA `874b8f685f156a8686534560405e16d26a6445dd915f00fe25610afbfaf75193`. Open `C:/Users/j6sis/.codex/worktrees/flight-loop-reset/SpaceSurvival/Play Packaged Review.cmd`; it uses a separate review profile and now includes the approved menu and gameplay follow-up. Check: (1) AlienFemale and walking, (2) ramp entry and Free Flight selection, (3) ordinary throttle/coasting, boost/brake and visible shots/HIT feedback. The [follow-up receipt](validation/2026-09-21-gameplay-followup.md) binds the current build and checks; the [reset receipt](validation/2026-09-21-flight-loop-reset.md) retains earlier package and artistic history. **Still open:** station composition/signage stays on the owner's hold; lead retains that unmet target and Phoenix section-paint capability. Physical keyboard/mouse/controller feel, listening, natural Waves1–10, clean-PC launch, representative performance and owner visual acceptance require their own evidence. Existing station art/layout and unrelated reports stay open. No merge or itch publication occurred.
