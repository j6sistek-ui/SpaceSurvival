...
**Package7 is the current review candidate; reports remain OPEN.** Source25cf794, inner EXE SHA `2bc44e7582a630e3dece3302ade2a48e1dd2a5c139f32c1535ac2502dd54895f`. Open `C:/Users/j6sis/.codex/worktrees/flight-loop-reset/SpaceSurvival/Play Packaged Review.cmd`; it uses a separate persistent review profile. Check: (1) wardrobe large text and scrolling, (2) preference slider alignment, (3) walking radar crew/service/pad markers and absence of flight vitals/weapon panel. [UI receipt](validation/2026-09-22-ui-refresh.md) binds this build; [Package5 history](validation/2026-09-22-world-feedback.md) retains input/physics evidence. **Still open:** lead owns unique service portraits/layouts, earlier GPU-memory warnings, full cockpit walking/seating, beacon reproduction and natural environment continuity. Failed non-evasive flight balance stays open. Station art is on hold; presets/remapping deferred. Physical input, natural Waves1-10, listening, clean-PC startup, performance and owner acceptance remain separate. No merge or publication.
