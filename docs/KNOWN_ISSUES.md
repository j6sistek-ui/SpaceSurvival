...
| 2 | Review the implemented Station Workshop | Owner + lead | PR14 has a built editor and ten presets; the owned-asset follow-up expands its exact filtered catalog from 677 to 708 placeable assets and preserves verified save/apply/export. Owner tries one prop edit; lead follows up on authoring feedback. See ISS-09 and the station guide. Bug repairs remain paused. |
...
| <a id="iss-02"></a>ISS-02 | Hero/ships and continuous animation remain provisional. The default starter is the purchased Havolk closed-cockpit assembly. When the owned Sci-Fi Space Character packages are present, the station walker now uses that temporary hero with its matching walk and exit animation; missing or incompatible content falls back to the original Acornaut. Automation covers both routes, but rendered/package review and the pinched-leg natural-motion retest remain open. The regular contributor still owns the long-term hero and iconic starter. [Current validation](VALIDATION.md), [earlier refresh](ASSET_REFRESH.md). | Needs owner retest + art work / regular 3D contributor; lead integrates | Judge the current hull and temporary hero in neutral, walking, turning and exit poses; verify package cooking before treating the local owned content as tester-ready. Preserve contributor ownership and original sources. PT-01,03,10,18. |
| <a id="iss-03"></a>ISS-03 | Station composition and ambience remain unaccepted. Capture-only reports RPT-20260914-02/03 and RPT-20260915-07 describe walk-through props, blockage near labels, an NPC intersecting a table and repeated collision damage after catching a station entrance edge; causes remain unconfirmed. The saved 380-component Blueprint contains corridor dressing, terminals, furnishings, two existing robot staff and task lighting. The owned-asset follow-up adds a nonblocking heavy-trooper staff member and drone when their local packages exist. Native collision/service anchors remain fixed. Cooked dependencies and packaged station images predate the new characters; owner composition, entrance behavior and natural-use acceptance remain open. [Station editing](STATION_EDITING.md). | Needs owner review / lead follows up | Verify one saved workshop edit, the temporary staff, natural approach/exit and service reachability. Reproduce the entrance-edge report before adjusting collision or damage cadence. PT-09,10,12,13,17,18. |
